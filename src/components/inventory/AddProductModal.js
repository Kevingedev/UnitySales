"use client";
import { Settings2, Tool,X, Package, Hash, DollarSign, Calendar, Tag } from "lucide-react";
    ...
    <div className="bg-[var(--card)] border border-[var(--border)] w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in duration-200">
      ...
      <form action={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex p-1 bg-zinc-500/5 rounded-xl border border-[var(--border)]">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-[10px] font-black transition-all ${
                productType === 'physical' ? 'bg-brand text-white shadow-lg' : 'text-zinc-500 opacity-50'
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-[10px] font-black transition-all ${
                productType === 'service' ? 'bg-brand text-white shadow-lg' : 'text-zinc-500 opacity-50'
              }`}
            >
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <InputGroup
            label={productType === 'physical' ? "Product/Unit Price" : "Service/Unit Price"}
            name="base_price"
