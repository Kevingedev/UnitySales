"use client";
import { X, Package, Hash, DollarSign, Calendar, Tag } from "lucide-react";
        ...
        <form action={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <InputGroup
              ...
              type="number"
              step="0.01"
              defaultValue={productToEdit?.cost_price}
              required
            />
            <InputGroup
              label="Min. Alert"
