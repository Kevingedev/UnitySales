    ...
    <div className="flex flex-col h-full space-y-4">
      ...
      <div className="relative z-10">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 mt-3 bg-[var(--card)] border border-[var(--border)] rounded-xl focus:ring-2 focus:ring-brand focus:border-brand outline-none transition-all font-medium text-sm shadow-sm text-[var(--foreground)] placeholder:text-zinc-500"
        />
      </div>
